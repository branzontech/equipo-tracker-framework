...
import { PERMISOS_SEDES } from "../../usuarios/interfaces/permisos";
...
const Sedes = () => {
  ...
  const puedeEditarEliminar =
    tienePermiso(PERMISOS_SEDES.edicion, user.permisos) ||
    tienePermiso(PERMISOS_SEDES.eliminacion, user.permisos);

  return (
    <>
      <div className="container mx-auto p-6">
        {tienePermiso(PERMISOS_SEDES.ingreso, user.permisos) && (
          <Card className="mb-6">
            <CardHeader>
              ...
              <TableBody>
                {[...sedes]
                  ...
                  .map((sede) => {
                    const acciones = [
                      {
                        permiso: PERMISOS_SEDES.edicion,
                        onClick: () => handleOpenEditModal(sede.id_sede),
                        icon: <PencilIcon className="h-5 w-5" />,
                      },
                      {
                        permiso: PERMISOS_SEDES.eliminacion,
