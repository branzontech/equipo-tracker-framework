...
import { PERMISOS_PROVEEDORES } from "../../usuarios/interfaces/permisos";
...
const Proveedores = () => {
  ...
  const puedeEditarEliminar =
    tienePermiso(PERMISOS_PROVEEDORES.edicion, user.permisos) ||
    tienePermiso(PERMISOS_PROVEEDORES.eliminacion, user.permisos);

  return (
    <div className="container mx-auto p-6">
      {tienePermiso(PERMISOS_PROVEEDORES.ingreso, user.permisos) && (
        <Card className="mb-6">
          <CardHeader>
            ...
            <TableBody>
              {proveedores.length > 0 ? (
                proveedores.map((proveedor) => {
                  const acciones = [
                    {
                      permiso: PERMISOS_PROVEEDORES.edicion,
                      onClick: () =>
                        handleOpenEditModal(proveedor.id_proveedor),
                      icon: <PencilIcon className="h-5 w-5" />,
                    },
                    {
                      permiso: PERMISOS_PROVEEDORES.eliminacion,
