...
const IngresoProducto = () => {
  ...
  return (
    <div className="p-8 h-screen flex flex-col">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col h-[calc(100vh-8rem)] overflow-y-auto pb-4">
          ...
          {/* Botones de acción */}
          <div className="flex justify-end space-x-4 mt-8 sticky bottom-0 bg-white py-4 border-t">
