...
import { DashboardItem, equiposData, incidentesData, mantenimientosData, rendimientoEquiposData, rendimientoTonerData, sedesData, serviciosActivosData, solicitudesData, tiempoRespuestaData, tonerData } from "@/pages/dashboard/interfaces/dashboardItem";
