...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "text-white bg-[#01242c] hover:bg-[#bff036] hover:text-[#01242c]",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-input bg-background hover:bg-[#bff036] hover:text-[#01242c] hover:border-[#01242c]",
        secondary:
          "bg-[#bff036] text-[#01242c] hover:bg-[#01242c] hover:text-[#bff036]",
        ghost: "hover:bg-[#bff036] hover:text-[#01242c]",
        link: "text-[#01242c] underline-offset-4 hover:underline",
      },
      size: {
